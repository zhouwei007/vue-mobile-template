  ...
  load: function () {
    return {
      ...
      // 滑动释放
        ...
        // 当为水平滚动时
        if ((this.direction == 1 || this.direction == -1) && this.isScrolling === 0) {
          // if (Number(duration) < 500) {
          //   // 判断是左移还是右移，当偏移量大于10时执行
          //   if (this.endPos.x > 10) {
          //     this.moveRight(this.curScale);
          //   } else if (this.endPos.x < -10) {
          //     this.moveLeft(this.curScale);
          //   }
          // } else {
          //   console.log('isRightGoOn:' + this.isRightGoOn);
          //   console.log('isLeftGoOn:' + this.isLeftGoOn);
